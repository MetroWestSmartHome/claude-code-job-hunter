...
- **Job Discovery:** Scrape Indeed/Google Jobs, filter by your criteria, score against your profile
...
- Filters by location, salary, remote preference, job titles
...
**What happens:**
1. Scrapes job boards (30 min)
2. Scores jobs against your profile (AI-assisted)
3. Checks company ratings for high-scoring jobs
4. You choose which job to pursue
5. Generates resume + cover letter (30-35 min)
6. Documents all optimizations (materials-generation-log.md)
7. You review, convert to .docx, run Jobscan
8. Tracks in APPLICATION_TRACKER.md
