...
4. Read `examplecompany-director-it/resume.md` for optimization examples
5. Read `examplecompany-director-it/Your_Name_Cover_Letter_ExampleCompany_v2.md` for tone
...
- `docs\resume-files\examplecompany-director-it\Your_Name_Cover_Letter_ExampleCompany_v2.md`
...
Folder naming: lowercase, hyphens, e.g., `unfi-sr-director-it-end-user-services`
...
- Emphasize relevant years of experience (e.g., "7+ years leading teams" for leadership role)

**Example (ExampleCompany):**
- Base: "Strategic IT leader with 15+ years managing enterprise technology operations..."
- Optimized: "Strategic IT leader with 15+ years in enterprise technology operations, including 7+ years leading teams in fast-paced, high-growth environments..."
- Changes: Added "high-growth" keyword, clarified management duration
...
### [Your Job Title]
**ExampleCompany (ExampleCompany Holdings)** | [YOUR_CITY, STATE] (Remote) | [START_DATE] – Present
...
### [Your Job Title]
**ExampleCompany** | [YOUR_CITY, STATE] | June 2019 – August 2023
...
### [Your Job Title]
**ExampleCompany** | [YOUR_CITY, STATE] | May 2013 – June 2019
...
**ExampleCompany** | [YOUR_CITY, STATE] | April 2010 – May 2013
...
Read `examplecompany-director-it/Your_Name_Cover_Letter_ExampleCompany_v2.md` in FULL.

Extract:
- **Tone** - Professional, no contractions, confident
- **Structure** - 6 paragraphs (opening, experience, strategic/hands-on, team dev, culture fit, gap addressing)
...
**Example:**
"The Director, Information Technology role at ExampleCompany caught my attention because it's looking for someone who works both strategically and hands-on. That has been my approach to IT leadership for the past seven years."
...
**Example from ExampleCompany v2 (SaaS gap):**
"While ExampleCompany is not technically SaaS, our IT operations have much in common with high-growth SaaS companies: rapid tool adoption, continuous deployment support, and infrastructure that needs to scale with engineering velocity. I have built event-driven automation platforms using Workflow Automation Platform, driven enterprise-wide SSO and SCIM provisioning adoption..."
...
**Example:**
"When I took over helpdesk operations during COVID, I inherited a team that was task-focused. I shifted them toward outcome-focused work, and one junior team member evolved from helpdesk to architecting our HR automation platform. I give my team permission to ask 'what tools or skills can I learn to solve this better?'"

**For this job:**
- Use helpdesk takeover example (proven success)
- Reference specific mentorship outcome (junior → architect)
- Show culture of learning approach
...
│   └── bullets-library.md
└── examplecompany-director-it/
    └── Your_Name_Cover_Letter_ExampleCompany_v2.md
